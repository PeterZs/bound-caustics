...
figure = CropComparison(
    ...
    method_images=[
        readexr("results/fig_plane_cs_gamma10.exr"),
        readexr("results/fig_plane_cs_one.exr"),
        readexr("results/fig_plane_cs_multiuni.exr"),
        readexr("results/fig_plane_cs_enum.exr"),
    ],
    crops=[
        Cropbox(top=230, left=1013, height=60, width=60, scale=5),
        Cropbox(top=400, left=420, height=60, width=60, scale=5),
    ],
    scene_name="Plane (25 sec)",
    method_names=["Reference (spp)","Ours gamma=10 (16)", "One-sample (64)", "Uniform P=0.04 (8)", "Enumerate (1)"]
)
figuregen.figure([figure.figure_row], width_cm=22, filename="results/cmp_sample_plane.pdf")
